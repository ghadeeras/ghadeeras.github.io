...
export class Renderer {
    ...
    renderTo(attachment: GPURenderPassColorAttachment, strokes: { group: cmn.StrokeBindGroup, closed: boolean, skipInitalCap: boolean, distance: number }[], view: cmn.ViewBindGroup) {
