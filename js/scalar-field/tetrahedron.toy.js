...
class Toy {
    constructor(shaders, scalarFieldInstance) {
        ...
        this._value3 = -1;
        this._value4 = -1;
        this._tetrahedronData = () => { };
        this._contourData = () => { };
        this._matProjectionData = () => { };
        this._matPositionsData = () => { };
        this.tetrahedron = newTetrahedron(0, 0, 0, 0);
    ...
    outputWiring(outputs) {
        ...
        gl.frontFace(gl.CCW);
        this._tetrahedronData = (data) => tetrahedronBuffer.data = data;
    ...
    render(context, drawTetrahedron, drawContour) {
        const gl = context.gl;
...
function tetrahedronData(tetrahedron) {
    ...
    return new Float32Array(tetrahedronVertexes.reduce((a, v) => a.concat(...v), []));
}
function contourSurfaceData(scalarFieldInstance, tetrahedron, contourValue) {
...
function fieldColor(fieldValue, alpha = 0.5) {
...
//# sourceMappingURL=tetrahedron.toy.js.map