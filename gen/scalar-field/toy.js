...
function doInit() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const toy = new Toy(view, v.required(wa.mem.exports), v.required(wa.space.exports), v.required(wa.scalarField.exports));
    });
}
class Toy {
    constructor(view, mem, space, scalarField) {
        ...
        this.contourValue = 0;
        this.fieldRef = 0;
        this.meshComputer = new gear.DeferredComputation(() => {
