...
export const eof = new TokenTypeImpl(regex.word("\u0000EOF\u0000"), s => null, s => "");
...
export function boolean(t = "true", f = "false") {
...
export class Token {
    constructor(tokenType, lexeme, position, replacedToken = null) {
