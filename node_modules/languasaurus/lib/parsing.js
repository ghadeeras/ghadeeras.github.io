...
export function recursiveDescentParser(tokenDefinitions, start, whitespace = undefined) {
    ...
    visitChoice(acceptor, symbol, input) {
        ...
        for (const p of productions) {
            if (this.grammar.firstSetOf(p).has(input.current.tokenType)) {
                return acceptor.accept(p, input);
            }
        }
