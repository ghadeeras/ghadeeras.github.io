...
export declare function runtime(waPath?: string, modulesLoader?: wa.ModulesLoader, rawMem?: ArrayBuffer | null): Promise<Runtime>;
export declare function createRuntime(rawMem: ArrayBuffer | null, modules: wa.WebAssemblyModules<keyof RuntimeExports>): Runtime;
export declare function loadRuntimeModules(waPath: string, modulesLoader?: wa.ModulesLoader): Promise<wa.WebAssemblyModules<RuntimeModuleNames>>;
