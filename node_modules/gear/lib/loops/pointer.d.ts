...
export declare class Pointer implements PointerInterface {
    ...
    private _position;
    private _pixelViewPosition;
    private _innerViewPosition;
    private _outerViewPosition;
...
export declare function draggingTarget<V>(property: Property<V>, dragger: Dragger<V>, positionType?: FilteredKeyOf<PointerInterface, PointerPosition>): DraggingTarget;
