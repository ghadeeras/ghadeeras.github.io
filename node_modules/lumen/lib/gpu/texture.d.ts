...
export declare class Texture implements utl.Resource<Texture> {
    ...
    private generate2DMipmaps;
    private mipLevel;
}
export declare class TextureView implements utl.Resource<Texture> {
...
export declare class Sampler implements utl.Resource<Sampler> {
    readonly device: Device;
