...
export class Texture {
    ...
    async generateMipmaps() {
        ...
        switch (this._wrapped.textureBindingViewDimension) {
            case "2d": return await this.generate2DMipmaps();
            case "2d-array": return await this.generate2DMipmaps();
            default: throw "Unsupported yet: " + this._wrapped.textureBindingViewDimension;
        }
    }
