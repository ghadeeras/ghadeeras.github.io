...
export declare class BindGroupLayoutEntry<R extends utl.Resource<any> = utl.Resource<any>> {
...
export declare abstract class ResourceBindingLayout<R extends utl.Resource<any> = utl.Resource<any>> {
