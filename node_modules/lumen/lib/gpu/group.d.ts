...
export type BindGroupResource<T extends BindGroupLayoutEntry> = IfSet<T, "buffer", SyncBuffer | Buffer> | IfSet<T, "texture", TextureView | Texture> | IfSet<T, "storageTexture", TextureView | Texture> | IfSet<T, "externalTexture", TextureView | Texture> | IfSet<T, "sampler", Sampler>;
