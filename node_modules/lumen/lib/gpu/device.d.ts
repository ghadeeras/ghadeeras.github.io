...
export declare class Device {
    ...
    private addListener;
    shaderModules<D extends shd.ShaderModuleDescriptors>(descriptors: D, labelPrefix?: string): Promise<shd.ShaderModules<D>>;
    shaderModule(descriptor: shd.ShaderModuleDescriptor): Promise<shd.ShaderModule>;
    ...
    enqueueCommands(label: string, encoding: (encoder: CommandEncoder) => void): void;
    enqueue(...commandBuffers: GPUCommandBuffer[]): void;
    ...
    sampler(descriptor?: GPUSamplerDescriptor | undefined): txr.Sampler;
