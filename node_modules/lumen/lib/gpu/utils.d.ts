...
export declare function withLabel<D extends GPUObjectDescriptorBase>(descriptor: D, ...labelParts: (string | undefined)[]): {
    label: string | undefined;
} & D;
export declare function label(...parts: (string | undefined)[]): string | undefined;
