export class SyncBuffer {
    ...
    static create(label, device, descriptor) {
...
export class DataBuffer extends AbstractBuffer {
    constructor(label, device, descriptor) {
...
function newBlankBuffer(device, label, usage, size) {
...
function newInitializedBuffer(device, label, usage, data) {
