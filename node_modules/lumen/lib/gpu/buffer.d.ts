...
export declare class SyncBuffer implements Resource {
    ...
    private dirty;
    private clean;
    static create(label: string, device: Device, descriptor: DataBufferDescriptor): SyncBuffer;
}
...
export declare abstract class AbstractBuffer implements BaseBuffer {
    private _device;
    private _wrapped;
    protected constructor(_device: Device, _wrapped: GPUBuffer);
...
export declare class DataBuffer extends AbstractBuffer implements SourceBuffer, DestinationBuffer {
    ...
    constructor(label: string, device: Device, descriptor: DataBufferDescriptor);
...
export declare class WriteBuffer extends AbstractBuffer implements SourceBuffer {
    ...
    private mapper;
    constructor(label: string, device: Device, data: DataView);
