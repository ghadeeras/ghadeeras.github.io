...
export class Device {
    ...
    async shaderModules(descriptors) {
        const result = {};
    ...
    async shaderModule(label, descriptor) {
    ...
    dataBuffer(label, descriptor) {
        return new buf.DataBuffer(label, this, descriptor);
    }
    readBuffers(descriptors) {
        const result = {};
        for (const k in descriptors) {
    ...
    readBuffer(label, size) {
        return new buf.ReadBuffer(label, this, size);
    }
    writeBuffers(descriptors) {
        const result = {};
        for (const k in descriptors) {
    ...
    syncBuffer(label, descriptor) {
        return buf.SyncBuffer.create(label, this, descriptor);
    }
    groupLayouts(descriptors) {
        const result = {};
        for (const k in descriptors) {
    ...
    groupLayout(label, descriptor) {
        return new grp.BindGroupLayout(this, label, descriptor);
    }
    pipelineLayouts(descriptors) {
        const result = {};
        for (const k in descriptors) {
    ...
    pipelineLayout(label, descriptor) {
